...
and to create the respective datasets that can be used in conjunction with
the TCGA datasets. This is a dataset based solely on the Genes of Interest
and a multiple controls whose composition is as close to the TCGA controls as possible. 

"""

# Reading the full RNA GTEx dataset
GTEx_Samp_df = pd.read_csv("../../../Data/RNA_Data/GTEx_RNA/Raw_GTEx_RNA_Norm.csv", index_col = 0, nrows= 4000)
...
# GTEx_SOI_df.to_csv('../../../Data/RNA_Data/GTEx_RNA/GTEx_RNA_SoI.csv', index = False)
...
# GTEx_Cntrl_df.to_csv('../../../Data/RNA_Data/GTEx_RNA/GTEx_RNA_Full_Cntrl.csv', index = False)

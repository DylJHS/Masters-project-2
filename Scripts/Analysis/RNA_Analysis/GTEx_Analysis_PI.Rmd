...
B) Create a barplot of the samples vs their differences in the mean log2 RNA values segmented by SMTSD
...
C) Apply a two-sided paired permutation test between the SOI and the control gene-set while grouping by cancer type in the form of Tissue Type and calculate the mean difference of each group

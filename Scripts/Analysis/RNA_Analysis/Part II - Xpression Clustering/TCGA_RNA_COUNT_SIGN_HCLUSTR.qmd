...
```{r}
lambda = 1 # ICSS negative cor penalty multiplier
alpha = 0.9 # ICDS scaling factor to adjust the sensitivity to differences between clusters
p = 5 # ICSS positive power
q = 2 # ICSS negative power
weight = 0.51 # the weight that is given to the ICSS
```
...
myBreaks <- c(seq(-1, 0.70, length.out = 100), seq(0.71, 1, length.out = 100))

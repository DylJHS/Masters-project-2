...
for (height in seq(2,length(node_heights)-1,5)){
  ...
  Intra_CCS <- total_intra_score / n_groups
  
  # print(total_intra_score)
  print(Intra_CCS)
  ...
  # Inter_CCS <- sum(inter_coef(clustered_corr))
  # 
  # 
  # # Total-CCS
  # 
  # Total_CSS <- Intra_CCS - Inter_CCS
  # 
  # 
  ...
  #              Intra.Score = Intra_CCS,
  #              Inter.Score = Inter_CCS,
  #              Total.Score = Total_CSS,

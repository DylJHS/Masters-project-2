...
Edit ids so as to be able to identify the condition (Cancer/Normal) as well as the Tissue Type (ex: Breast, Lung ...) based on the tumour type and its corresponding control group

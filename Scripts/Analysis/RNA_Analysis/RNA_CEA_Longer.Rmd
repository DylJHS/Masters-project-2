...
B) Calculate the significance of the difference between the mean expression of both sets using a Wilcoxon Signed-Rank Test
...
C) Demonstrate difference by showing the individual expression distributions of the SoI
...
Impact on future analyses: future test can now just use a single control set to test against as it has been shown that the controls do not differ significantly from one another and all share a similar difference with the SoI.

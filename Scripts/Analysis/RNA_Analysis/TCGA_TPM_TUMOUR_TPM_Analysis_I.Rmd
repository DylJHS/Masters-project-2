---
title: "TCGA TUMOUR TPM ANALYSIS PI"
output: html_document
date: "2024-02-13"
Note: This is the script for the analysis of the cancerous only TCGA data. For the combined analysis see TCGA_TUMOUR_NORMAL_ANALYSIS. For the full analysis see TCGA_TPM_mRNA_FULL_ANALYSIS. 
---
...
for (i in 1:num_datasets) {
  ...
  ctrl_file <- paste("Data/RNA_Data/TCGA_TPM/TCGA_Cancer_CTRL_Sets/TCGA_TPM_RNA_Control_df", i, ".csv", sep = "")
...
end_time <- Sys.time()
cat("Total duration: ", end_time - start_time, "minutes")
```
...
file_name <- paste("Data/RNA_Data/TCGA_TPM/TCGA_Cancer_CTRL_Sets/TCGA_TPM_RNA_Control_df", main_ctrl_num, ".csv", sep = "")
...
C) Create barplot of each Tissue Type group, based on mean Expression difference.

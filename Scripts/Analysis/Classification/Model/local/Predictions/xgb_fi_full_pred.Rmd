...
top_barplt <- ggplot(top_gene_each, aes(x = reorder(Target, Gain), y = Gain)) +
  ...
  geom_text(aes(label = Feature), hjust = -0.3, size = 3, angle = -90)
...
colors_above_midpoint <- colorRampPalette(c("#F4F9FC", "#D21717"))(num_breaks - midpoint_index)

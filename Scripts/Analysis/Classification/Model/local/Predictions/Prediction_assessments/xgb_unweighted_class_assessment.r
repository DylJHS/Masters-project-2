...
# save the data
write.csv(confusion_matrix_data, paste0("Data/Model_output/Unwtd_confusion_Matrix_", target, ".csv"))

# save the plot
ggsave(paste0("Data/Model_output/Unwtd_confusion_Matrix_", target, ".png"), heatmap_plot, width = 10, height = 10, units = "in", dpi = 300)

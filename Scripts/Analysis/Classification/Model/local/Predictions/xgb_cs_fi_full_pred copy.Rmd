...
ggsave(
  filename = paste0(
    filefold,
    "Genomic_Feature_Importance_Heatmap.png"
  ),
  plot = gene_heatmap,
  width = 10,
  height = 10
...
model_dependency_heatmap <- pheatmap(
  top_genes_complete,
  color = colors,
  breaks = breaks,
  cluster_rows = FALSE,
...
ggsave(
  filename = paste0(
    ...
    "/",
    cancer_type,
    "/Plots/Feature_importance/Model_Interdependence_Heatmap.png"
  ),
  plot = model_dependency_heatmap,
  width = 10,
  height = 10
)
...
```{r}
print(paste0("The analysis for ", cancer_type, " is complete."))
```

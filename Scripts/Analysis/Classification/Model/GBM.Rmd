...
order_tpm <- order_tpm[row_samples,0:7500]
order_exp <- order_exp[row_samples,0:7500]
...
```{r}
write.csv(metrics_df, paste0("Data/gbm_metrics_params_",Sys.Date(), ".csv"))
```

...
```{r}
rna_list <- list(transcripts_per_million = tpm_set,
...
feature_list <- list("loh_hrd","ai1", "lst1", "Aneuploidy Score")
...
for (i in 1:length(rna_list)){
  ...
  for (feature in feature_list){
    ...
    for (depth in seq(2,5)){
      cat(paste0("Depth: ", depth, "\n"))
      for (lr in seq(0.10,0.20, by = 0.02)){
        cat(paste0("Learning Rate: ", lr, "\n"))
